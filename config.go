...
type Config struct {
	...
	// Used by the runtime to enforce maxFanOut on run_agents.
...
type DelegationConfig struct {
	Strategy       string `json:"strategy"`                 // "proactive", "conservative", "manual"
	PreferParallel bool   `json:"preferParallel,omitempty"` // favor run_agents over sequential run_agent
